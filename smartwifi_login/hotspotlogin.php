...
function display_notyet() {
	global $header_content, $display_form, $msg, $body_cont, $display_login_form, $display_lead_form , $username, $password, $display_ques_form, $display_video_form, $display_fblike_form;
	...
	$display_login_form = '<form class="form-signin">
				...
				<input type="text" id="inputUsername" class="inputUsername" placeholder="Username">
				...
				<label class="checkbox">
					<input type="checkbox" checked> I wish to get contacted with latest  offers and Services.
				</label>
	...
	$display_lead_form = '<form class="form-signin">
				<h4>Get free WiFi  access for 15 mins.</h4>
				<input type="text" id="inputName" class="inputName" placeholder="Your Name"><br><br>
				<input type="text" id="inputUsername" class="inputUsername" placeholder="Username">
				<input type="text" id="inputPassword" class="inputPassword" placeholder="Password">
				<label class="checkbox">
					<input type="checkbox" id="inputTerms" checked><a href="#terms" data-toggle="modal">I Agree to Terms of Use</a>
	...
	$display_ques_form = '<form class="form-signin">
				<h4>Get free WiFi  access for 15 mins.</h4>
				<p>Do you like smartWiFi?</p>
					<input type="radio" id="inputLikeYes" name="likeSW" class="inputLike">&nbsp; &nbsp;Yes &nbsp; &nbsp;
					<input type="radio" id="inputLikeNo" name="likeSW" class="inputLike">&nbsp; &nbsp;No<br><br>
				<p> What more could we add to our login services?</p>
				<textarea id="inputServ" class="inputServ"  placeholder="Suggestions"></textarea><br><br>
				<input type="text" id="inputName" class="inputName" placeholder="Your Name"><br><br>
				<input type="text" id="inputUsername" class="inputUsername" placeholder="Username">
				<input type="text" id="inputPassword" class="inputPassword" placeholder="Password">
	...
	$display_video_form = '<h4>Watch the video to get free WiFi access for 15 mins.</h4>
			<div id="player"></div>
			<form class="form-signin">
				...
				<input type="text" id="inputUsername" class="inputUsername" placeholder="Username">
				<input type="text" id="inputPassword" class="inputPassword" placeholder="Password">
				<button type="button" id="video_btn" disabled class="btn" onClick="sub_form()">Get Free Wifi</button>
			</form>';
	
	$display_fblike_form = '<form class="form-signin">
				<h4>Get free WiFi  access for 15 mins.</h4>
				<input type="text" id="inputfbUsername" class="inputfbUsername" placeholder="Username">
				<input type="text" id="inputfbPassword" class="inputfbPassword" placeholder="Password">
				<label class="checkbox">
					<input type="checkbox" id="inputTerms" checked><a href="#terms" data-toggle="modal">I Agree to Terms of Use</a>
				</label>
				<label class="checkbox">
...
<html>
    <head>
        ...
        <script src="assets/js/fbconnect.js" type="text/javascript"></script>
    ...
    <body <?php echo $body_cont; ?> >
    	<div class="container">
        	<div class="logo">
            	<img src="assets/img/citi/smartwifi_logo.png" width="">
                <h4>How would you login today!!</h4>
            </div>
            
        	<div class="list_carousel7 responsive" >
								<ul id="foo7">
									<li><a href="#free"  data-toggle="modal"><div class="thumb"><img src="assets/img/citi/free.png" alt="orange">
											<h5><span class="dark"><b>Free @SmartWiFi</b></span><br/><span class="light"></span></h5></div></a></li>
											
									<li><a href="#lead"  data-toggle="modal"><div class="thumb"><img src="assets/img/citi/lead.png" alt="orange">
											<h5><span class="dark"><b>Leads @ SmartWiFi</b></span><br/><span class="light"></span></h5></div></a></li>
											
									<li><a href="#ques"  data-toggle="modal"><div class="thumb"><img src="assets/img/citi/ques.png" alt="sociality">
											<h5><span class="dark"><b>Questionnaire @ SmartWiFi</b></span><br/><span class="light"></span></h5></div></a></li>
											
									<li><a  onClick="fblike_window();" style="cursor:pointer" ><div class="thumb"><img src="assets/img/citi/fblike.png" alt="organic">
											<h5><span class="dark"><b>Facebook Like @ SmartWiFi</b></span><br/><span class="light"></span></h5></div></a></li>
											
									<!--
                                    <li><a href="#tweetaboutus"  data-toggle="modal"><div class="thumb"><img src="assets/img/citi/tweet.png" alt="pixel">
											<h5><span class="dark"><b>Tweet @ SmartWiFi</b></span><br/><span class="light">Tweet about us</span></h5></div></a></li>
									-->
                                     <!--   	
									<li><a href="#game"  data-toggle="modal"><div class="thumb"><img src="assets/img/citi/game.png" alt="golf">
											<h5><span class="dark"><br/><b>Play Game @ SmartWiFi</b></span><br/><span class="light">Play a game to login</span></h5></div></a></li>
                                    -->
                                    
                                    <li><a onClick="video_window();" style="cursor:pointer"  ><div class="thumb"><img src="assets/img/citi/video.png" alt="golf">
											<h5><span class="dark"><br/><b>Videos @ SmartWiFi</b></span><br/><span class="light"></span></h5></div></a></li>
            ...
            <div class="apply">
            	<a href="#apply" class="btn btn-large btn-primary" role="button" data-toggle="modal">Custom Advert/Form</a>
            </div>
            <div style="">
            	<h4>Steps to login</h4>
                <p style="line-height: 18px; font-size: 12px;">
                	1. <b>SMS "SMARTWIFI" to 56263</b>, you will receive a username and password.<br>
                    2. Connect to SMARTWIFI, WiFi hotspot.<br>
                    3. Select how would you like to login.<br>
                    4. Enter username and password and click on "Get Free WiFi", to gain access to free WiFi.<br>
                    5. Enjoy your free 15 mins WiFi.<br>
                </p>
            </div>
...
<div id="apply" class="modal hide fade in" style="display: none; ">  
    <div class="modal-header">  
        ...
        <h3>Custom Advertisement or Form</h3>
    </div> 
...
<div id="free" class="modal hide fade in" style="display: none; ">  
    <div class="modal-header">  
        <a class="close" data-dismiss="modal">×</a>  
        <h3>Free Access</h3>
    </div> 
    <div class="modal-body">
        ...
        Adverts:<br>
        <img src="assets/img/citi/banner1.gif">
    </div>
    <div class="modal-footer">
        <a href="#" class="btn" data-dismiss="modal">Close</a>
    </div>
...
<div id="lead" class="modal hide fade in" style="display: none; ">  
    <div class="modal-header">  
        <a class="close" data-dismiss="modal">×</a>  
        <h3>Fill details to Connect to WiFi</h3>
    </div> 
    <div class="modal-body">
        <?php echo $display_lead_form; ?>
    </div>
</div>

<div id="ques" class="modal hide fade in" style="display: none; ">  
    <div class="modal-header">  
        <a class="close" data-dismiss="modal">×</a>  
        <h3>Fill details to Connect to WiFi</h3>
    </div> 
    <div class="modal-body">
        <?php echo $display_ques_form; ?>
    </div>
</div>
...
<div id="video" class="modal hide fade in" style="display: none; ">  
    ...
    <div class="modal-body">
        ...
        <video id="video_1" class="video-js vjs-default-skin" controls preload="none" width="480" height="264"
              poster="assets/video-js/citi.png"
              data-setup="{}">
            <source src="assets/video-js/citivid.mp4" type='video/mp4' />
            <source src="assets/video-js/citivid.webm" type='video/webm' />
            <source src="assets/video-js/citivid.ogv" type='video/ogg' />
          </video>
    	
        <?php echo $display_video_form; ?>
    </div>
</div>

<div id="fblike" class="modal hide fade in" style="display: none; ">  
    <div class="modal-header">  
        <a class="close" data-dismiss="modal">×</a>  
        <h3>Connect to WiFi by Liking Us on Facebook</h3>
    </div> 
    <div class="modal-body">
    	<img src="assets/img/citi/iandsfbpage.jpg" width="300"><br><br>
        <div id="like_button"><a onClick="fbstart();" class="like_button_link">Like</a></div>
    	<div id="fb-root"></div>
	    <div class="fb-like" data-href="http://www.facebook.com/ideasNsolutions" data-send="false" data-width="450" data-show-faces="false"></div>
        <br><br>
        <?php echo $display_fblike_form; ?>
    </div>
</div>
...
$('#video').on('hidden', function () {
  myPlayer.pause();
});

myPlayer.on("ended", enableBut);

function enableBut(){
	$('#video_btn').removeAttr('disabled');
}


function fblike_window() {
		$('#fblike').modal('show');	
}

function sub_form() {
	var user_field = document.getElementById('inputfbUsername');
	var pass_field = document.getElementById('inputfbPassword');
	
		if(user_field.value!='' && pass_field.value!='') {
			if($('#inputTerms').is(':checked')) {
				var myuser = document.getElementById('username');
				var mypass = document.getElementById('password');
				myuser.value = user_field.value;
				mypass.value =pass_field.value;
				...
				var form_data = {
					...
					var request = $.ajax({
						url: "http://smartwifi.in/smartwifi_login/savefbdata.php",
						type: 'POST',
						data: form_data,
					});
		...
		FB.Event.subscribe('edge.create', function(response) {
		    FB.login(function(loginResponse) {
			   if (loginResponse.authResponse) {
					...
					alert('Like clicked: User cancelled login or did not fully authorize.');
				}				    
	    });	
    });
